Trabalho Final do Curso de Programação Orientada a Objetos Este projeto tem como objetivo principal desenvolver uma lista de transações simples, com armazenamento das informações em arquivos no formato .csv.
