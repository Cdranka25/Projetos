...
class CTkCheckBox(CTkBaseClass):
    def __init__(self, master: Any, width: int = 100, height: int = 24, checkbox_width: int = 24, checkbox_height: int = 24, corner_radius: int | None = None, border_width: int | None = None, bg_color: str | tuple[str, str] = 'transparent', fg_color: str | tuple[str, str] | None = None, hover_color: str | tuple[str, str] | None = None, border_color: str | tuple[str, str] | None = None, checkmark_color: str | tuple[str, str] | None = None, text_color: str | tuple[str, str] | None = None, text_color_disabled: str | tuple[str, str] | None = None, text: str = 'CTkCheckBox', font: tuple | CTkFont | None = None, textvariable: tkinter.Variable | None = None, state: str = ..., hover: bool = True, command: Callable[[], Any] | None = None, onvalue: int | str = 1, offvalue: int | str = 0, variable: tkinter.Variable | None = None, **kwargs) -> None: ...
    def destroy(self) -> None: ...
    def configure(self, require_redraw: bool = False, **kwargs) -> None: ...
    def cget(self, attribute_name: str) -> any: ...
    def toggle(self, event: int = 0) -> None: ...
